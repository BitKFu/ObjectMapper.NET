...
{
	/// <summary>
	/// Summary description for ValidUntilAttribute.
	/// </summary>
	[AttributeUsage(AttributeTargets.Property | AttributeTargets.Class, Inherited = true, AllowMultiple = false)]
	[Serializable]
    [Obsolete("This flag won't supported anymore in future versions.")]
    public sealed class ValidUntilAttribute : Attribute
	{
		...
		public ValidUntilAttribute(double _version)
		{
		...
		public ValidUntilAttribute(string _majorVersion, string _minorVersion)
		{
