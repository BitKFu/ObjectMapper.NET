    ...
    public class ObjectMapperSetup : ObjectMapperTest 
    {
        ...
        public void RunBeforeAnyTests()
        {
            ...
            using (var mapper = OBM.CreateMapper(Connection))
            {
                ...
                mapper.Save(fullFeaturedCompany);
                mapper.Save(company);
                OBM.Commit(mapper, nested);

                fullFeaturedCompany = mapper.Load(typeof(FullFeaturedCompany), fullFeaturedCompany.Id) as FullFeaturedCompany;
                company = mapper.Load(typeof(Company), company.Id) as Company;
            }
        ...
        public void UnloadCaches()
        {
            ...
            {
                bool nested = OBM.BeginTransaction(mapper);
                mapper.DeleteRecursive(fullFeaturedCompany, HierarchyLevel.AllDependencies);
