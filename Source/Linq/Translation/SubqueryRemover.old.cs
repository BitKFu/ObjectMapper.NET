...
namespace AdFactum.Data.Linq.Translation
{
    ...
    public class SubqueryRemover : DbExpressionVisitor
    {
        ...
        {
            return Remove(outerSelect, dynamicCache, selectsToRemove.ToList());
        }

        public static SelectExpression Remove(SelectExpression outerSelect, Cache<Type, ProjectionClass> dynamicCache, List<SelectExpression> selectsToRemove)
        {
