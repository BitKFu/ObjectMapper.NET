...
AppVerName=ObjectMapper .NET 2.3.3903.0
...
AllowNoIcons=yes
OutputDir=D:\Release\ObjectMapper .NET
OutputBaseFilename=ObjectMapper_2.3.3903.0
Compression=lzma
SolidCompression=yes

[Files]
Source: D:\Release\ObjectMapper .NET\Release 2.3.3903.0\*.*; DestDir: {app}; Flags: ignoreversion recursesubdirs
