...
Alter Table Employees
    Disable Constraint FK_Employees_Employees;

Insert Into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,PhotoPath) 
VALUES(1,'Davolio','Nancy','Sales Representative','Ms.',Trunc(To_TimeStamp('12/08/1948', 'MM/DD/YYYY')),Trunc(To_TimeStamp('05/01/1992', 'MM/DD/YYYY')),'507 - 20th Ave. E. Apt. 2A','Seattle','WA','98122','USA','(206) 555-9857','5467',
2,'http://accweb/emmployees/davolio.bmp');

Insert Into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,PhotoPath) 
VALUES(2,'Fuller','Andrew','Vice President, Sales','Dr.',Trunc(To_TimeStamp('02/19/1952', 'MM/DD/YYYY')),Trunc(To_TimeStamp('08/14/1992', 'MM/DD/YYYY')),'908 W. Capital Way','Tacoma','WA','98401','USA','(206) 555-9482','3457',
NULL,'http://accweb/emmployees/fuller.bmp');

Insert Into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,PhotoPath) 
VALUES(3,'Leverling','Janet','Sales Representative','Ms.',Trunc(To_TimeStamp('08/30/1963', 'MM/DD/YYYY')),Trunc(To_TimeStamp('04/01/1992', 'MM/DD/YYYY')),'722 Moss Bay Blvd.','Kirkland','WA','98033','USA','(206) 555-3412','3355',
2,'http://accweb/emmployees/leverling.bmp');

Insert Into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,PhotoPath) 
VALUES(4,'Peacock','Margaret','Sales Representative','Mrs.',Trunc(To_TimeStamp('09/19/1937', 'MM/DD/YYYY')),Trunc(To_TimeStamp('05/03/1993', 'MM/DD/YYYY')),'4110 Old Redmond Rd.','Redmond','WA','98052','USA','(206) 555-8122','5176',
2,'http://accweb/emmployees/peacock.bmp');

Insert Into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,PhotoPath) 
VALUES(5,'Buchanan','Steven','Sales Manager','Mr.',Trunc(To_TimeStamp('03/04/1955', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/17/1993', 'MM/DD/YYYY')),'14 Garrett Hill','London',NULL,'SW1 8JR','UK','(71) 555-4848','3453',
2,'http://accweb/emmployees/buchanan.bmp');

Insert Into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,PhotoPath) 
VALUES(6,'Suyama','Michael','Sales Representative','Mr.',Trunc(To_TimeStamp('07/02/1963', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/17/1993', 'MM/DD/YYYY')),'Coventry House Miner Rd.','London',NULL,'EC2 7JR','UK','(71) 555-7773','428',
5,'http://accweb/emmployees/davolio.bmp');

Insert Into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,PhotoPath) 
VALUES(7,'King','Robert','Sales Representative','Mr.',Trunc(To_TimeStamp('05/29/1960', 'MM/DD/YYYY')),Trunc(To_TimeStamp('01/02/1994', 'MM/DD/YYYY')),'Edgeham Hollow Winchester Way','London',NULL,'RG1 9SP','UK','(71) 555-5598','465',
5,'http://accweb/emmployees/davolio.bmp');

Insert Into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,PhotoPath) 
VALUES(8,'Callahan','Laura','Inside Sales Coordinator','Ms.',Trunc(To_TimeStamp('01/09/1958', 'MM/DD/YYYY')),Trunc(To_TimeStamp('03/05/1994', 'MM/DD/YYYY')),'4726 - 11th Ave. N.E.','Seattle','WA','98105','USA','(206) 555-1189','2344',
2,'http://accweb/emmployees/davolio.bmp');

Insert Into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,PhotoPath) 
VALUES(9,'Dodsworth','Anne','Sales Representative','Ms.',Trunc(To_TimeStamp('01/27/1966', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/15/1994', 'MM/DD/YYYY')),'7 Houndstooth Rd.','London',NULL,'WG2 7LT','UK','(71) 555-4444','452',
5,'http://accweb/emmployees/davolio.bmp');

Alter Table Employees
    Enable Constraint FK_Employees_Employees;

Commit;


Alter Table Order_Details
    Disable Constraint FK_Order_Details_Products;
    
Alter Table Order_Details
    Disable Constraint FK_Order_Details_Orders;
...
Alter Table Orders
    Disable Constraint FK_Orders_Shippers;
...
VALUES (10248,'VINET',5,Trunc(To_TimeStamp('7/4/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/1/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/16/1996', 'MM/DD/YYYY')),3,32.38,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10249,'TOMSP',6,Trunc(To_TimeStamp('7/5/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/16/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/10/1996', 'MM/DD/YYYY')),1,11.61,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10250,'HANAR',4,Trunc(To_TimeStamp('7/8/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/5/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/12/1996', 'MM/DD/YYYY')),2,65.83,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10251,'VICTE',3,Trunc(To_TimeStamp('7/8/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/5/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/15/1996', 'MM/DD/YYYY')),1,41.34,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10252,'SUPRD',4,Trunc(To_TimeStamp('7/9/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/6/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/11/1996', 'MM/DD/YYYY')),2,51.30,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10253,'HANAR',3,Trunc(To_TimeStamp('7/10/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/24/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/16/1996', 'MM/DD/YYYY')),2,58.17,
'Hanari Carnes','Rua do Paço, 67','Rio de Janeiro',
'RJ','05454-876','Brazil');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10254,'CHOPS',5,Trunc(To_TimeStamp('7/11/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/8/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/23/1996', 'MM/DD/YYYY')),2,22.98,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10255,'RICSU',9,Trunc(To_TimeStamp('7/12/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/9/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/15/1996', 'MM/DD/YYYY')),3,148.33,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10256,'WELLI',3,Trunc(To_TimeStamp('7/15/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/12/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/17/1996', 'MM/DD/YYYY')),2,13.97,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10257,'HILAA',4,Trunc(To_TimeStamp('7/16/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/13/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/22/1996', 'MM/DD/YYYY')),3,81.91,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10258,'ERNSH',1,Trunc(To_TimeStamp('7/17/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/14/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/23/1996', 'MM/DD/YYYY')),1,140.51,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10259,'CENTC',4,Trunc(To_TimeStamp('7/18/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/15/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/25/1996', 'MM/DD/YYYY')),3,3.25,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10260,'OTTIK',4,Trunc(To_TimeStamp('7/19/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/16/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/29/1996', 'MM/DD/YYYY')),1,55.09,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10261,'QUEDE',4,Trunc(To_TimeStamp('7/19/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/16/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/30/1996', 'MM/DD/YYYY')),2,3.05,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10262,'RATTC',8,Trunc(To_TimeStamp('7/22/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/19/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/25/1996', 'MM/DD/YYYY')),3,48.29,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10263,'ERNSH',9,Trunc(To_TimeStamp('7/23/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/20/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/31/1996', 'MM/DD/YYYY')),3,146.06,
'Ernst Handel','Kirchgasse 6','Graz',
    NULL,'8010','Austria');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10264,'FOLKO',6,Trunc(To_TimeStamp('7/24/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/21/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/23/1996', 'MM/DD/YYYY')),3,3.67,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10265,'BLONP',2,Trunc(To_TimeStamp('7/25/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/22/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/12/1996', 'MM/DD/YYYY')),1,55.28,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10266,'WARTH',3,Trunc(To_TimeStamp('7/26/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/6/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('7/31/1996', 'MM/DD/YYYY')),3,25.73,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10267,'FRANK',4,Trunc(To_TimeStamp('7/29/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/26/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/6/1996', 'MM/DD/YYYY')),1,208.58,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10268,'GROSR',8,Trunc(To_TimeStamp('7/30/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/27/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/2/1996', 'MM/DD/YYYY')),3,66.29,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10269,'WHITC',5,Trunc(To_TimeStamp('7/31/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/14/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/9/1996', 'MM/DD/YYYY')),1,4.56,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10270,'WARTH',1,Trunc(To_TimeStamp('8/1/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/29/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/2/1996', 'MM/DD/YYYY')),1,136.54,
'Wartian Herkku','Torikatu 38','Oulu',
    NULL,'90110','Finland');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10271,'SPLIR',6,Trunc(To_TimeStamp('8/1/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/29/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/30/1996', 'MM/DD/YYYY')),2,4.54,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10272,'RATTC',6,Trunc(To_TimeStamp('8/2/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/30/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/6/1996', 'MM/DD/YYYY')),2,98.03,
'Rattlesnake Canyon Grocery','2817 Milton Dr.','Albuquerque',
'NM','87110','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10273,'QUICK',3,Trunc(To_TimeStamp('8/5/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/2/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/12/1996', 'MM/DD/YYYY')),3,76.07,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10274,'VINET',6,Trunc(To_TimeStamp('8/6/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/3/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/16/1996', 'MM/DD/YYYY')),1,6.01,
'Vins et alcools Chevalier','59 rue de l''Abbaye','Reims',
    NULL,'51100','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10275,'MAGAA',1,Trunc(To_TimeStamp('8/7/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/4/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/9/1996', 'MM/DD/YYYY')),1,26.93,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10276,'TORTU',8,Trunc(To_TimeStamp('8/8/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/22/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/14/1996', 'MM/DD/YYYY')),3,13.84,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10277,'MORGK',2,Trunc(To_TimeStamp('8/9/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/6/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/13/1996', 'MM/DD/YYYY')),3,125.77,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10278,'BERGS',8,Trunc(To_TimeStamp('8/12/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/9/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/16/1996', 'MM/DD/YYYY')),2,92.69,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10279,'LEHMS',8,Trunc(To_TimeStamp('8/13/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/10/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/16/1996', 'MM/DD/YYYY')),2,25.83,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10280,'BERGS',2,Trunc(To_TimeStamp('8/14/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/11/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/12/1996', 'MM/DD/YYYY')),1,8.98,
'Berglunds snabbköp','Berguvsvägen  8','Luleå',
    NULL,'S-958 22','Sweden');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10281,'ROMEY',4,Trunc(To_TimeStamp('8/14/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/28/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/21/1996', 'MM/DD/YYYY')),1,2.94,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10282,'ROMEY',4,Trunc(To_TimeStamp('8/15/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/12/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/21/1996', 'MM/DD/YYYY')),1,12.69,
'Romero y tomillo','Gran Vía, 1','Madrid',
    NULL,'28001','Spain');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10283,'LILAS',3,Trunc(To_TimeStamp('8/16/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/13/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/23/1996', 'MM/DD/YYYY')),3,84.81,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10284,'LEHMS',4,Trunc(To_TimeStamp('8/19/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/16/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/27/1996', 'MM/DD/YYYY')),1,76.56,
'Lehmanns Marktstand','Magazinweg 7','Frankfurt a.M.',
    NULL,'60528','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10285,'QUICK',1,Trunc(To_TimeStamp('8/20/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/17/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/26/1996', 'MM/DD/YYYY')),2,76.83,
'QUICK-Stop','Taucherstraße 10','Cunewalde',
    NULL,'01307','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10286,'QUICK',8,Trunc(To_TimeStamp('8/21/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/18/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/30/1996', 'MM/DD/YYYY')),3,229.24,
'QUICK-Stop','Taucherstraße 10','Cunewalde',
    NULL,'01307','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10287,'RICAR',8,Trunc(To_TimeStamp('8/22/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/19/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/28/1996', 'MM/DD/YYYY')),3,12.76,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10288,'REGGC',4,Trunc(To_TimeStamp('8/23/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/20/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/3/1996', 'MM/DD/YYYY')),1,7.45,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10289,'BSBEV',7,Trunc(To_TimeStamp('8/26/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/23/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('8/28/1996', 'MM/DD/YYYY')),3,22.77,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10290,'COMMI',8,Trunc(To_TimeStamp('8/27/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/24/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/3/1996', 'MM/DD/YYYY')),1,79.70,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10291,'QUEDE',6,Trunc(To_TimeStamp('8/27/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/24/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/4/1996', 'MM/DD/YYYY')),2,6.40,
'Que Delícia','Rua da Panificadora, 12','Rio de Janeiro',
'RJ','02389-673','Brazil');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10292,'TRADH',1,Trunc(To_TimeStamp('8/28/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/25/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/2/1996', 'MM/DD/YYYY')),2,1.35,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10293,'TORTU',1,Trunc(To_TimeStamp('8/29/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/26/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/11/1996', 'MM/DD/YYYY')),3,21.18,
'Tortuga Restaurante','Avda. Azteca 123','México D.F.',
    NULL,'05033','Mexico');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10294,'RATTC',4,Trunc(To_TimeStamp('8/30/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/27/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/5/1996', 'MM/DD/YYYY')),2,147.26,
'Rattlesnake Canyon Grocery','2817 Milton Dr.','Albuquerque',
'NM','87110','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10295,'VINET',2,Trunc(To_TimeStamp('9/2/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/30/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/10/1996', 'MM/DD/YYYY')),2,1.15,
'Vins et alcools Chevalier','59 rue de l''Abbaye','Reims',
    NULL,'51100','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10296,'LILAS',6,Trunc(To_TimeStamp('9/3/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/1/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/11/1996', 'MM/DD/YYYY')),1,0.12,
'LILA-Supermercado','Carrera 52 con Ave. Bolívar #65-98 Llano Largo','Barquisimeto',
'Lara','3508','Venezuela');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10297,'BLONP',5,Trunc(To_TimeStamp('9/4/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/16/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/10/1996', 'MM/DD/YYYY')),2,5.74,
'Blondel père et fils','24, place Kléber','Strasbourg',
    NULL,'67000','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10298,'HUNGO',6,Trunc(To_TimeStamp('9/5/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/3/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/11/1996', 'MM/DD/YYYY')),2,168.22,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10299,'RICAR',4,Trunc(To_TimeStamp('9/6/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/4/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/13/1996', 'MM/DD/YYYY')),2,29.76,
'Ricardo Adocicados','Av. Copacabana, 267','Rio de Janeiro',
'RJ','02389-890','Brazil');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10300,'MAGAA',2,Trunc(To_TimeStamp('9/9/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/7/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/18/1996', 'MM/DD/YYYY')),2,17.68,
'Magazzini Alimentari Riuniti','Via Ludovico il Moro 22','Bergamo',
    NULL,'24100','Italy');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10301,'WANDK',8,Trunc(To_TimeStamp('9/9/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/7/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/17/1996', 'MM/DD/YYYY')),2,45.08,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10302,'SUPRD',4,Trunc(To_TimeStamp('9/10/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/8/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/9/1996', 'MM/DD/YYYY')),2,6.27,
'Suprêmes délices','Boulevard Tirou, 255','Charleroi',
    NULL,'B-6000','Belgium');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10303,'GODOS',7,Trunc(To_TimeStamp('9/11/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/9/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/18/1996', 'MM/DD/YYYY')),2,107.83,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10304,'TORTU',1,Trunc(To_TimeStamp('9/12/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/10/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/17/1996', 'MM/DD/YYYY')),2,63.79,
'Tortuga Restaurante','Avda. Azteca 123','México D.F.',
    NULL,'05033','Mexico');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10305,'OLDWO',8,Trunc(To_TimeStamp('9/13/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/11/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/9/1996', 'MM/DD/YYYY')),3,257.62,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10306,'ROMEY',1,Trunc(To_TimeStamp('9/16/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/14/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/23/1996', 'MM/DD/YYYY')),3,7.56,
'Romero y tomillo','Gran Vía, 1','Madrid',
    NULL,'28001','Spain');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10307,'LONEP',2,Trunc(To_TimeStamp('9/17/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/15/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/25/1996', 'MM/DD/YYYY')),2,0.56,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10308,'ANATR',7,Trunc(To_TimeStamp('9/18/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/16/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/24/1996', 'MM/DD/YYYY')),3,1.61,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10309,'HUNGO',3,Trunc(To_TimeStamp('9/19/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/17/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/23/1996', 'MM/DD/YYYY')),1,47.30,
'Hungry Owl All-Night Grocers','8 Johnstown Road','Cork',
'Co. Cork',NULL,'Ireland');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10310,'THEBI',8,Trunc(To_TimeStamp('9/20/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/18/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/27/1996', 'MM/DD/YYYY')),2,17.52,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10311,'DUMON',1,Trunc(To_TimeStamp('9/20/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/4/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('9/26/1996', 'MM/DD/YYYY')),3,24.69,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10312,'WANDK',2,Trunc(To_TimeStamp('9/23/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/21/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/3/1996', 'MM/DD/YYYY')),2,40.26,
'Die Wandernde Kuh','Adenauerallee 900','Stuttgart',
    NULL,'70563','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10313,'QUICK',2,Trunc(To_TimeStamp('9/24/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/22/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/4/1996', 'MM/DD/YYYY')),2,1.96,
'QUICK-Stop','Taucherstraße 10','Cunewalde',
    NULL,'01307','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10314,'RATTC',1,Trunc(To_TimeStamp('9/25/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/23/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/4/1996', 'MM/DD/YYYY')),2,74.16,
'Rattlesnake Canyon Grocery','2817 Milton Dr.','Albuquerque',
'NM','87110','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10315,'ISLAT',4,Trunc(To_TimeStamp('9/26/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/24/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/3/1996', 'MM/DD/YYYY')),2,41.76,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10316,'RATTC',1,Trunc(To_TimeStamp('9/27/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/25/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/8/1996', 'MM/DD/YYYY')),3,150.15,
'Rattlesnake Canyon Grocery','2817 Milton Dr.','Albuquerque',
'NM','87110','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10317,'LONEP',6,Trunc(To_TimeStamp('9/30/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/28/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/10/1996', 'MM/DD/YYYY')),1,12.69,
'Lonesome Pine Restaurant','89 Chiaroscuro Rd.','Portland',
'OR','97219','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10318,'ISLAT',8,Trunc(To_TimeStamp('10/1/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/29/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/4/1996', 'MM/DD/YYYY')),2,4.73,
'Island Trading','Garden House Crowther Way','Cowes',
'Isle of Wight','PO31 7PJ','UK');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10319,'TORTU',7,Trunc(To_TimeStamp('10/2/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/30/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/11/1996', 'MM/DD/YYYY')),3,64.50,
'Tortuga Restaurante','Avda. Azteca 123','México D.F.',
    NULL,'05033','Mexico');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10320,'WARTH',5,Trunc(To_TimeStamp('10/3/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/17/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/18/1996', 'MM/DD/YYYY')),3,34.57,
'Wartian Herkku','Torikatu 38','Oulu',
    NULL,'90110','Finland');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10321,'ISLAT',3,Trunc(To_TimeStamp('10/3/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/31/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/11/1996', 'MM/DD/YYYY')),2,3.43,
'Island Trading','Garden House Crowther Way','Cowes',
'Isle of Wight','PO31 7PJ','UK');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10322,'PERIC',7,Trunc(To_TimeStamp('10/4/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/1/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/23/1996', 'MM/DD/YYYY')),3,0.40,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10323,'KOENE',4,Trunc(To_TimeStamp('10/7/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/4/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/14/1996', 'MM/DD/YYYY')),1,4.88,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10324,'SAVEA',9,Trunc(To_TimeStamp('10/8/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/5/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/10/1996', 'MM/DD/YYYY')),1,214.27,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10325,'KOENE',1,Trunc(To_TimeStamp('10/9/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/23/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/14/1996', 'MM/DD/YYYY')),3,64.86,
'Königlich Essen','Maubelstr. 90','Brandenburg',
    NULL,'14776','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10326,'BOLID',4,Trunc(To_TimeStamp('10/10/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/7/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/14/1996', 'MM/DD/YYYY')),2,77.92,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10327,'FOLKO',2,Trunc(To_TimeStamp('10/11/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/8/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/14/1996', 'MM/DD/YYYY')),1,63.36,
'Folk och fä HB','Åkergatan 24','Bräcke',
    NULL,'S-844 67','Sweden');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10328,'FURIB',4,Trunc(To_TimeStamp('10/14/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/11/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/17/1996', 'MM/DD/YYYY')),3,87.03,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10329,'SPLIR',4,Trunc(To_TimeStamp('10/15/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/26/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/23/1996', 'MM/DD/YYYY')),2,191.67,
'Split Rail Beer & Ale','P.O. Box 555','Lander',
'WY','82520','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10330,'LILAS',3,Trunc(To_TimeStamp('10/16/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/13/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/28/1996', 'MM/DD/YYYY')),1,12.75,
'LILA-Supermercado','Carrera 52 con Ave. Bolívar #65-98 Llano Largo','Barquisimeto',
'Lara','3508','Venezuela');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10331,'BONAP',9,Trunc(To_TimeStamp('10/16/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/27/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/21/1996', 'MM/DD/YYYY')),1,10.19,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10332,'MEREP',3,Trunc(To_TimeStamp('10/17/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/28/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/21/1996', 'MM/DD/YYYY')),2,52.84,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10333,'WARTH',5,Trunc(To_TimeStamp('10/18/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/15/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/25/1996', 'MM/DD/YYYY')),3,0.59,
'Wartian Herkku','Torikatu 38','Oulu',
    NULL,'90110','Finland');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10334,'VICTE',8,Trunc(To_TimeStamp('10/21/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/18/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/28/1996', 'MM/DD/YYYY')),2,8.56,
'Victuailles en stock','2, rue du Commerce','Lyon',
    NULL,'69004','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10335,'HUNGO',7,Trunc(To_TimeStamp('10/22/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/19/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/24/1996', 'MM/DD/YYYY')),2,42.11,
'Hungry Owl All-Night Grocers','8 Johnstown Road','Cork',
'Co. Cork',NULL,'Ireland');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10336,'PRINI',7,Trunc(To_TimeStamp('10/23/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/20/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/25/1996', 'MM/DD/YYYY')),2,15.51,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10337,'FRANK',4,Trunc(To_TimeStamp('10/24/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/21/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/29/1996', 'MM/DD/YYYY')),3,108.26,
'Frankenversand','Berliner Platz 43','München',
    NULL,'80805','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10338,'OLDWO',4,Trunc(To_TimeStamp('10/25/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/22/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('10/29/1996', 'MM/DD/YYYY')),3,84.21,
'Old World Delicatessen','2743 Bering St.','Anchorage',
'AK','99508','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10339,'MEREP',2,Trunc(To_TimeStamp('10/28/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/25/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/4/1996', 'MM/DD/YYYY')),2,15.66,
'Mère Paillarde','43 rue St. Laurent','Montréal',
'Québec','H1J 1C3','Canada');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10340,'BONAP',1,Trunc(To_TimeStamp('10/29/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/26/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/8/1996', 'MM/DD/YYYY')),3,166.31,
'Bon app''','12, rue des Bouchers','Marseille',
    NULL,'13008','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10341,'SIMOB',7,Trunc(To_TimeStamp('10/29/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/26/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/5/1996', 'MM/DD/YYYY')),3,26.78,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10342,'FRANK',4,Trunc(To_TimeStamp('10/30/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/13/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/4/1996', 'MM/DD/YYYY')),2,54.83,
'Frankenversand','Berliner Platz 43','München',
    NULL,'80805','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10343,'LEHMS',4,Trunc(To_TimeStamp('10/31/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/28/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/6/1996', 'MM/DD/YYYY')),1,110.37,
'Lehmanns Marktstand','Magazinweg 7','Frankfurt a.M.',
    NULL,'60528','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10344,'WHITC',4,Trunc(To_TimeStamp('11/1/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/29/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/5/1996', 'MM/DD/YYYY')),2,23.29,
'White Clover Markets','1029 - 12th Ave. S.','Seattle',
'WA','98124','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10345,'QUICK',2,Trunc(To_TimeStamp('11/4/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/2/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/11/1996', 'MM/DD/YYYY')),2,249.06,
'QUICK-Stop','Taucherstraße 10','Cunewalde',
    NULL,'01307','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10346,'RATTC',3,Trunc(To_TimeStamp('11/5/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/17/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/8/1996', 'MM/DD/YYYY')),3,142.08,
'Rattlesnake Canyon Grocery','2817 Milton Dr.','Albuquerque',
'NM','87110','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10347,'FAMIA',4,Trunc(To_TimeStamp('11/6/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/4/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/8/1996', 'MM/DD/YYYY')),3,3.10,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10348,'WANDK',4,Trunc(To_TimeStamp('11/7/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/5/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/15/1996', 'MM/DD/YYYY')),2,0.78,
'Die Wandernde Kuh','Adenauerallee 900','Stuttgart',
    NULL,'70563','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10349,'SPLIR',7,Trunc(To_TimeStamp('11/8/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/6/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/15/1996', 'MM/DD/YYYY')),1,8.63,
'Split Rail Beer & Ale','P.O. Box 555','Lander',
'WY','82520','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10350,'LAMAI',6,Trunc(To_TimeStamp('11/11/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/9/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/3/1996', 'MM/DD/YYYY')),2,64.19,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10351,'ERNSH',1,Trunc(To_TimeStamp('11/11/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/9/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/20/1996', 'MM/DD/YYYY')),1,162.33,
'Ernst Handel','Kirchgasse 6','Graz',
    NULL,'8010','Austria');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10352,'FURIB',3,Trunc(To_TimeStamp('11/12/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/26/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/18/1996', 'MM/DD/YYYY')),3,1.30,
'Furia Bacalhau e Frutos do Mar','Jardim das rosas n. 32','Lisboa',
    NULL,'1675','Portugal');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10353,'PICCO',7,Trunc(To_TimeStamp('11/13/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/11/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/25/1996', 'MM/DD/YYYY')),3,360.63,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10354,'PERIC',8,Trunc(To_TimeStamp('11/14/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/12/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/20/1996', 'MM/DD/YYYY')),3,53.80,
'Pericles Comidas clásicas','Calle Dr. Jorge Cash 321','México D.F.',
    NULL,'05033','Mexico');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10355,'AROUT',6,Trunc(To_TimeStamp('11/15/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/13/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/20/1996', 'MM/DD/YYYY')),1,41.95,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10356,'WANDK',6,Trunc(To_TimeStamp('11/18/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/16/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/27/1996', 'MM/DD/YYYY')),2,36.71,
'Die Wandernde Kuh','Adenauerallee 900','Stuttgart',
    NULL,'70563','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10357,'LILAS',1,Trunc(To_TimeStamp('11/19/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/17/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/2/1996', 'MM/DD/YYYY')),3,34.88,
'LILA-Supermercado','Carrera 52 con Ave. Bolívar #65-98 Llano Largo','Barquisimeto',
'Lara','3508','Venezuela');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10358,'LAMAI',5,Trunc(To_TimeStamp('11/20/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/18/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/27/1996', 'MM/DD/YYYY')),1,19.64,
'La maison d''Asie','1 rue Alsace-Lorraine','Toulouse',
    NULL,'31000','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10359,'SEVES',5,Trunc(To_TimeStamp('11/21/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/19/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/26/1996', 'MM/DD/YYYY')),3,288.43,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10360,'BLONP',4,Trunc(To_TimeStamp('11/22/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/20/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/2/1996', 'MM/DD/YYYY')),3,131.70,
'Blondel père et fils','24, place Kléber','Strasbourg',
    NULL,'67000','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10361,'QUICK',1,Trunc(To_TimeStamp('11/22/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/20/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/3/1996', 'MM/DD/YYYY')),2,183.17,
'QUICK-Stop','Taucherstraße 10','Cunewalde',
    NULL,'01307','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10362,'BONAP',3,Trunc(To_TimeStamp('11/25/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/23/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('11/28/1996', 'MM/DD/YYYY')),1,96.04,
'Bon app''','12, rue des Bouchers','Marseille',
    NULL,'13008','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10363,'DRACD',4,Trunc(To_TimeStamp('11/26/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/24/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/4/1996', 'MM/DD/YYYY')),3,30.54,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10364,'EASTC',1,Trunc(To_TimeStamp('11/26/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/7/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/4/1996', 'MM/DD/YYYY')),1,71.97,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10365,'ANTON',3,Trunc(To_TimeStamp('11/27/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/25/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/2/1996', 'MM/DD/YYYY')),2,22.00,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10366,'GALED',8,Trunc(To_TimeStamp('11/28/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/9/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/30/1996', 'MM/DD/YYYY')),2,10.14,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10367,'VAFFE',7,Trunc(To_TimeStamp('11/28/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/26/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/2/1996', 'MM/DD/YYYY')),3,13.55,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10368,'ERNSH',2,Trunc(To_TimeStamp('11/29/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/27/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/2/1996', 'MM/DD/YYYY')),2,101.95,
'Ernst Handel','Kirchgasse 6','Graz',
    NULL,'8010','Austria');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10369,'SPLIR',8,Trunc(To_TimeStamp('12/2/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/30/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/9/1996', 'MM/DD/YYYY')),2,195.68,
'Split Rail Beer & Ale','P.O. Box 555','Lander',
'WY','82520','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10370,'CHOPS',6,Trunc(To_TimeStamp('12/3/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/31/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/27/1996', 'MM/DD/YYYY')),2,1.17,
'Chop-suey Chinese','Hauptstr. 31','Bern',
    NULL,'3012','Switzerland');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10371,'LAMAI',1,Trunc(To_TimeStamp('12/3/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/31/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/24/1996', 'MM/DD/YYYY')),1,0.45,
'La maison d''Asie','1 rue Alsace-Lorraine','Toulouse',
    NULL,'31000','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10372,'QUEEN',5,Trunc(To_TimeStamp('12/4/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/1/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/9/1996', 'MM/DD/YYYY')),2,890.78,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10373,'HUNGO',4,Trunc(To_TimeStamp('12/5/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/2/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/11/1996', 'MM/DD/YYYY')),3,124.12,
'Hungry Owl All-Night Grocers','8 Johnstown Road','Cork',
'Co. Cork',NULL,'Ireland');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10374,'WOLZA',1,Trunc(To_TimeStamp('12/5/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/2/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/9/1996', 'MM/DD/YYYY')),3,3.94,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10375,'HUNGC',3,Trunc(To_TimeStamp('12/6/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/3/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/9/1996', 'MM/DD/YYYY')),2,20.12,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10376,'MEREP',1,Trunc(To_TimeStamp('12/9/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/6/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/13/1996', 'MM/DD/YYYY')),2,20.39,
'Mère Paillarde','43 rue St. Laurent','Montréal',
'Québec','H1J 1C3','Canada');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10377,'SEVES',1,Trunc(To_TimeStamp('12/9/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/6/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/13/1996', 'MM/DD/YYYY')),3,22.21,
'Seven Seas Imports','90 Wadhurst Rd.','London',
    NULL,'OX15 4NB','UK');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10378,'FOLKO',5,Trunc(To_TimeStamp('12/10/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/7/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/19/1996', 'MM/DD/YYYY')),3,5.44,
'Folk och fä HB','Åkergatan 24','Bräcke',
    NULL,'S-844 67','Sweden');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10379,'QUEDE',2,Trunc(To_TimeStamp('12/11/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/8/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/13/1996', 'MM/DD/YYYY')),1,45.03,
'Que Delícia','Rua da Panificadora, 12','Rio de Janeiro',
'RJ','02389-673','Brazil');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10380,'HUNGO',8,Trunc(To_TimeStamp('12/12/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/9/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/16/1997', 'MM/DD/YYYY')),3,35.03,
'Hungry Owl All-Night Grocers','8 Johnstown Road','Cork',
'Co. Cork',NULL,'Ireland');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10381,'LILAS',3,Trunc(To_TimeStamp('12/12/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/9/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/13/1996', 'MM/DD/YYYY')),3,7.99,
'LILA-Supermercado','Carrera 52 con Ave. Bolívar #65-98 Llano Largo','Barquisimeto',
'Lara','3508','Venezuela');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10382,'ERNSH',4,Trunc(To_TimeStamp('12/13/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/10/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/16/1996', 'MM/DD/YYYY')),1,94.77,
'Ernst Handel','Kirchgasse 6','Graz',
    NULL,'8010','Austria');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10383,'AROUT',8,Trunc(To_TimeStamp('12/16/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/13/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/18/1996', 'MM/DD/YYYY')),3,34.24,
'Around the Horn','Brook Farm Stratford St. Mary','Colchester',
'Essex','CO7 6JX','UK');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10384,'BERGS',3,Trunc(To_TimeStamp('12/16/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/13/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/20/1996', 'MM/DD/YYYY')),3,168.64,
'Berglunds snabbköp','Berguvsvägen  8','Luleå',
    NULL,'S-958 22','Sweden');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10385,'SPLIR',1,Trunc(To_TimeStamp('12/17/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/14/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/23/1996', 'MM/DD/YYYY')),2,30.96,
'Split Rail Beer & Ale','P.O. Box 555','Lander',
'WY','82520','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10386,'FAMIA',9,Trunc(To_TimeStamp('12/18/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/1/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/25/1996', 'MM/DD/YYYY')),3,13.99,
'Familia Arquibaldo','Rua Orós, 92','Sao Paulo',
'SP','05442-030','Brazil');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10387,'SANTG',1,Trunc(To_TimeStamp('12/18/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/15/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/20/1996', 'MM/DD/YYYY')),2,93.63,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10388,'SEVES',2,Trunc(To_TimeStamp('12/19/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/16/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/20/1996', 'MM/DD/YYYY')),1,34.86,
'Seven Seas Imports','90 Wadhurst Rd.','London',
    NULL,'OX15 4NB','UK');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10389,'BOTTM',4,Trunc(To_TimeStamp('12/20/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/17/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/24/1996', 'MM/DD/YYYY')),2,47.42,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10390,'ERNSH',6,Trunc(To_TimeStamp('12/23/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/20/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/26/1996', 'MM/DD/YYYY')),1,126.38,
'Ernst Handel','Kirchgasse 6','Graz',
    NULL,'8010','Austria');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10391,'DRACD',3,Trunc(To_TimeStamp('12/23/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/20/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('12/31/1996', 'MM/DD/YYYY')),3,5.45,
'Drachenblut Delikatessen','Walserweg 21','Aachen',
    NULL,'52066','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10392,'PICCO',2,Trunc(To_TimeStamp('12/24/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/21/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/1/1997', 'MM/DD/YYYY')),3,122.46,
'Piccolo und mehr','Geislweg 14','Salzburg',
    NULL,'5020','Austria');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10393,'SAVEA',1,Trunc(To_TimeStamp('12/25/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/22/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/3/1997', 'MM/DD/YYYY')),3,126.56,
'Save-a-lot Markets','187 Suffolk Ln.','Boise',
'ID','83720','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10394,'HUNGC',1,Trunc(To_TimeStamp('12/25/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/22/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/3/1997', 'MM/DD/YYYY')),3,30.34,
'Hungry Coyote Import Store','City Center Plaza 516 Main St.','Elgin',
'OR','97827','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10395,'HILAA',6,Trunc(To_TimeStamp('12/26/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/23/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/3/1997', 'MM/DD/YYYY')),1,184.41,
'HILARION-Abastos','Carrera 22 con Ave. Carlos Soublette #8-35','San Cristóbal',
'Táchira','5022','Venezuela');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10396,'FRANK',1,Trunc(To_TimeStamp('12/27/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/10/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/6/1997', 'MM/DD/YYYY')),3,135.35,
'Frankenversand','Berliner Platz 43','München',
    NULL,'80805','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10397,'PRINI',5,Trunc(To_TimeStamp('12/27/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/24/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/2/1997', 'MM/DD/YYYY')),1,60.26,
'Princesa Isabel Vinhos','Estrada da saúde n. 58','Lisboa',
    NULL,'1756','Portugal');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10398,'SAVEA',2,Trunc(To_TimeStamp('12/30/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/27/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/9/1997', 'MM/DD/YYYY')),3,89.16,
'Save-a-lot Markets','187 Suffolk Ln.','Boise',
'ID','83720','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10399,'VAFFE',8,Trunc(To_TimeStamp('12/31/1996', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/14/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/8/1997', 'MM/DD/YYYY')),3,27.36,
'Vaffeljernet','Smagsloget 45','Århus',
    NULL,'8200','Denmark');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10400,'EASTC',1,Trunc(To_TimeStamp('1/1/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/29/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/16/1997', 'MM/DD/YYYY')),3,83.93,
'Eastern Connection','35 King George','London',
    NULL,'WX3 6FW','UK');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10401,'RATTC',1,Trunc(To_TimeStamp('1/1/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/29/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/10/1997', 'MM/DD/YYYY')),1,12.51,
'Rattlesnake Canyon Grocery','2817 Milton Dr.','Albuquerque',
'NM','87110','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10402,'ERNSH',8,Trunc(To_TimeStamp('1/2/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/13/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/10/1997', 'MM/DD/YYYY')),2,67.88,
'Ernst Handel','Kirchgasse 6','Graz',
    NULL,'8010','Austria');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10403,'ERNSH',4,Trunc(To_TimeStamp('1/3/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/31/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/9/1997', 'MM/DD/YYYY')),3,73.79,
'Ernst Handel','Kirchgasse 6','Graz',
    NULL,'8010','Austria');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10404,'MAGAA',2,Trunc(To_TimeStamp('1/3/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/31/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/8/1997', 'MM/DD/YYYY')),1,155.97,
'Magazzini Alimentari Riuniti','Via Ludovico il Moro 22','Bergamo',
    NULL,'24100','Italy');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10405,'LINOD',1,Trunc(To_TimeStamp('1/6/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/3/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/22/1997', 'MM/DD/YYYY')),1,34.82,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10406,'QUEEN',7,Trunc(To_TimeStamp('1/7/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/18/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/13/1997', 'MM/DD/YYYY')),1,108.04,
'Queen Cozinha','Alameda dos Canàrios, 891','Sao Paulo',
'SP','05487-020','Brazil');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10407,'OTTIK',2,Trunc(To_TimeStamp('1/7/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/4/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/30/1997', 'MM/DD/YYYY')),2,91.48,
'Ottilies Käseladen','Mehrheimerstr. 369','Köln',
    NULL,'50739','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10408,'FOLIG',8,Trunc(To_TimeStamp('1/8/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/5/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/14/1997', 'MM/DD/YYYY')),1,11.26,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10409,'OCEAN',3,Trunc(To_TimeStamp('1/9/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/6/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/14/1997', 'MM/DD/YYYY')),1,29.83,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10410,'BOTTM',3,Trunc(To_TimeStamp('1/10/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/7/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/15/1997', 'MM/DD/YYYY')),3,2.40,
'Bottom-Dollar Markets','23 Tsawassen Blvd.','Tsawassen',
'BC','T2F 8M4','Canada');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10411,'BOTTM',9,Trunc(To_TimeStamp('1/10/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/7/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/21/1997', 'MM/DD/YYYY')),3,23.65,
'Bottom-Dollar Markets','23 Tsawassen Blvd.','Tsawassen',
'BC','T2F 8M4','Canada');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10412,'WARTH',8,Trunc(To_TimeStamp('1/13/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/10/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/15/1997', 'MM/DD/YYYY')),2,3.77,
'Wartian Herkku','Torikatu 38','Oulu',
    NULL,'90110','Finland');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10413,'LAMAI',3,Trunc(To_TimeStamp('1/14/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/11/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/16/1997', 'MM/DD/YYYY')),2,95.66,
'La maison d''Asie','1 rue Alsace-Lorraine','Toulouse',
    NULL,'31000','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10414,'FAMIA',2,Trunc(To_TimeStamp('1/14/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/11/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/17/1997', 'MM/DD/YYYY')),3,21.48,
'Familia Arquibaldo','Rua Orós, 92','Sao Paulo',
'SP','05442-030','Brazil');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10415,'HUNGC',3,Trunc(To_TimeStamp('1/15/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/12/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/24/1997', 'MM/DD/YYYY')),1,0.20,
'Hungry Coyote Import Store','City Center Plaza 516 Main St.','Elgin',
'OR','97827','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10416,'WARTH',8,Trunc(To_TimeStamp('1/16/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/13/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/27/1997', 'MM/DD/YYYY')),3,22.72,
'Wartian Herkku','Torikatu 38','Oulu',
    NULL,'90110','Finland');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10417,'SIMOB',4,Trunc(To_TimeStamp('1/16/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/13/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/28/1997', 'MM/DD/YYYY')),3,70.29,
'Simons bistro','Vinbæltet 34','Kobenhavn',
    NULL,'1734','Denmark');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10418,'QUICK',4,Trunc(To_TimeStamp('1/17/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/14/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/24/1997', 'MM/DD/YYYY')),1,17.55,
'QUICK-Stop','Taucherstraße 10','Cunewalde',
    NULL,'01307','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10419,'RICSU',4,Trunc(To_TimeStamp('1/20/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/17/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/30/1997', 'MM/DD/YYYY')),2,137.35,
'Richter Supermarkt','Starenweg 5','Genève',
    NULL,'1204','Switzerland');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10420,'WELLI',3,Trunc(To_TimeStamp('1/21/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/18/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/27/1997', 'MM/DD/YYYY')),1,44.12,
'Wellington Importadora','Rua do Mercado, 12','Resende',
'SP','08737-363','Brazil');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10421,'QUEDE',8,Trunc(To_TimeStamp('1/21/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/4/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/27/1997', 'MM/DD/YYYY')),1,99.23,
'Que Delícia','Rua da Panificadora, 12','Rio de Janeiro',
'RJ','02389-673','Brazil');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10422,'FRANS',2,Trunc(To_TimeStamp('1/22/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/19/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/31/1997', 'MM/DD/YYYY')),1,3.02,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10423,'GOURL',6,Trunc(To_TimeStamp('1/23/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/6/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/24/1997', 'MM/DD/YYYY')),3,24.50,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10424,'MEREP',7,Trunc(To_TimeStamp('1/23/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/20/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('1/27/1997', 'MM/DD/YYYY')),2,370.61,
'Mère Paillarde','43 rue St. Laurent','Montréal',
'Québec','H1J 1C3','Canada');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10425,'LAMAI',6,Trunc(To_TimeStamp('1/24/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/21/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/14/1997', 'MM/DD/YYYY')),2,7.93,
'La maison d''Asie','1 rue Alsace-Lorraine','Toulouse',
    NULL,'31000','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10426,'GALED',4,Trunc(To_TimeStamp('1/27/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/24/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/6/1997', 'MM/DD/YYYY')),1,18.69,
'Galería del gastronómo','Rambla de Cataluña, 23','Barcelona',
    NULL,'8022','Spain');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10427,'PICCO',4,Trunc(To_TimeStamp('1/27/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/24/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/3/1997', 'MM/DD/YYYY')),2,31.29,
'Piccolo und mehr','Geislweg 14','Salzburg',
    NULL,'5020','Austria');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10428,'REGGC',7,Trunc(To_TimeStamp('1/28/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/25/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/4/1997', 'MM/DD/YYYY')),1,11.09,
'Reggiani Caseifici','Strada Provinciale 124','Reggio Emilia',
    NULL,'42100','Italy');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10429,'HUNGO',3,Trunc(To_TimeStamp('1/29/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/12/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/7/1997', 'MM/DD/YYYY')),2,56.63,
'Hungry Owl All-Night Grocers','8 Johnstown Road','Cork',
'Co. Cork',NULL,'Ireland');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10430,'ERNSH',4,Trunc(To_TimeStamp('1/30/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/13/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/3/1997', 'MM/DD/YYYY')),1,458.78,
'Ernst Handel','Kirchgasse 6','Graz',
    NULL,'8010','Austria');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10431,'BOTTM',4,Trunc(To_TimeStamp('1/30/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/13/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/7/1997', 'MM/DD/YYYY')),2,44.17,
'Bottom-Dollar Markets','23 Tsawassen Blvd.','Tsawassen',
'BC','T2F 8M4','Canada');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10432,'SPLIR',3,Trunc(To_TimeStamp('1/31/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/14/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/7/1997', 'MM/DD/YYYY')),2,4.34,
'Split Rail Beer & Ale','P.O. Box 555','Lander',
'WY','82520','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10433,'PRINI',3,Trunc(To_TimeStamp('2/3/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/3/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/4/1997', 'MM/DD/YYYY')),3,73.83,
'Princesa Isabel Vinhos','Estrada da saúde n. 58','Lisboa',
    NULL,'1756','Portugal');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10434,'FOLKO',3,Trunc(To_TimeStamp('2/3/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/3/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/13/1997', 'MM/DD/YYYY')),2,17.92,
'Folk och fä HB','Åkergatan 24','Bräcke',
    NULL,'S-844 67','Sweden');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10435,'CONSH',8,Trunc(To_TimeStamp('2/4/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/18/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/7/1997', 'MM/DD/YYYY')),2,9.21,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10436,'BLONP',3,Trunc(To_TimeStamp('2/5/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/5/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/11/1997', 'MM/DD/YYYY')),2,156.66,
'Blondel père et fils','24, place Kléber','Strasbourg',
    NULL,'67000','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10437,'WARTH',8,Trunc(To_TimeStamp('2/5/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/5/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/12/1997', 'MM/DD/YYYY')),1,19.97,
'Wartian Herkku','Torikatu 38','Oulu',
    NULL,'90110','Finland');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10438,'TOMSP',3,Trunc(To_TimeStamp('2/6/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/6/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/14/1997', 'MM/DD/YYYY')),2,8.24,
'Toms Spezialitäten','Luisenstr. 48','Münster',
    NULL,'44087','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10439,'MEREP',6,Trunc(To_TimeStamp('2/7/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/7/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/10/1997', 'MM/DD/YYYY')),3,4.07,
'Mère Paillarde','43 rue St. Laurent','Montréal',
'Québec','H1J 1C3','Canada');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10440,'SAVEA',4,Trunc(To_TimeStamp('2/10/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/10/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/28/1997', 'MM/DD/YYYY')),2,86.53,
'Save-a-lot Markets','187 Suffolk Ln.','Boise',
'ID','83720','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10441,'OLDWO',3,Trunc(To_TimeStamp('2/10/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/24/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/14/1997', 'MM/DD/YYYY')),2,73.02,
'Old World Delicatessen','2743 Bering St.','Anchorage',
'AK','99508','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10442,'ERNSH',3,Trunc(To_TimeStamp('2/11/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/11/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/18/1997', 'MM/DD/YYYY')),2,47.94,
'Ernst Handel','Kirchgasse 6','Graz',
    NULL,'8010','Austria');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10443,'REGGC',8,Trunc(To_TimeStamp('2/12/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/12/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/14/1997', 'MM/DD/YYYY')),1,13.95,
'Reggiani Caseifici','Strada Provinciale 124','Reggio Emilia',
    NULL,'42100','Italy');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10444,'BERGS',3,Trunc(To_TimeStamp('2/12/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/12/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/21/1997', 'MM/DD/YYYY')),3,3.50,
'Berglunds snabbköp','Berguvsvägen  8','Luleå',
    NULL,'S-958 22','Sweden');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10445,'BERGS',3,Trunc(To_TimeStamp('2/13/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/13/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/20/1997', 'MM/DD/YYYY')),1,9.30,
'Berglunds snabbköp','Berguvsvägen  8','Luleå',
    NULL,'S-958 22','Sweden');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10446,'TOMSP',6,Trunc(To_TimeStamp('2/14/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/14/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/19/1997', 'MM/DD/YYYY')),1,14.68,
'Toms Spezialitäten','Luisenstr. 48','Münster',
    NULL,'44087','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10447,'RICAR',4,Trunc(To_TimeStamp('2/14/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/14/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/7/1997', 'MM/DD/YYYY')),2,68.66,
'Ricardo Adocicados','Av. Copacabana, 267','Rio de Janeiro',
'RJ','02389-890','Brazil');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10448,'RANCH',4,Trunc(To_TimeStamp('2/17/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/17/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/24/1997', 'MM/DD/YYYY')),2,38.82,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10449,'BLONP',3,Trunc(To_TimeStamp('2/18/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/18/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/27/1997', 'MM/DD/YYYY')),2,53.30,
'Blondel père et fils','24, place Kléber','Strasbourg',
    NULL,'67000','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10450,'VICTE',8,Trunc(To_TimeStamp('2/19/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/19/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/11/1997', 'MM/DD/YYYY')),2,7.23,
'Victuailles en stock','2, rue du Commerce','Lyon',
    NULL,'69004','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10451,'QUICK',4,Trunc(To_TimeStamp('2/19/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/5/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/12/1997', 'MM/DD/YYYY')),3,189.09,
'QUICK-Stop','Taucherstraße 10','Cunewalde',
    NULL,'01307','Germany');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10452,'SAVEA',8,Trunc(To_TimeStamp('2/20/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/20/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/26/1997', 'MM/DD/YYYY')),1,140.26,
'Save-a-lot Markets','187 Suffolk Ln.','Boise',
'ID','83720','USA');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10453,'AROUT',1,Trunc(To_TimeStamp('2/21/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/21/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/26/1997', 'MM/DD/YYYY')),2,25.36,
'Around the Horn','Brook Farm Stratford St. Mary','Colchester',
'Essex','CO7 6JX','UK');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10454,'LAMAI',4,Trunc(To_TimeStamp('2/21/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/21/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('2/25/1997', 'MM/DD/YYYY')),3,2.74,
'La maison d''Asie','1 rue Alsace-Lorraine','Toulouse',
    NULL,'31000','France');
Insert Into Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
    ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
    ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10455,'WARTH',8,Trunc(To_TimeStamp('2/24/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('4/7/1997', 'MM/DD/YYYY')),Trunc(To_TimeStamp('3/3/1997', 'MM/DD/YYYY')),2,180.45,
'Wartian Herkku','Torikatu 38','Oulu',
    NULL,'90110','Finland');
Commit;